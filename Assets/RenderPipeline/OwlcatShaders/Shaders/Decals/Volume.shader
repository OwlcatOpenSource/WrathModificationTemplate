Shader "Owlcat/Decals/Volume"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "DECAL STENCIL FRONT"
            Tags { "LightMode" = "DecalStencilFront" }
            ...
            #pragma fragment DecalFragmentStencil
        ...
        Pass
        {
            Name "DECAL STENCIL BACK"
            Tags { "LightMode" = "DecalStencilBack" }
        ...
        Pass
        {
            Name "DECAL STENCIL CLEAR"
            Tags { "LightMode" = "DecalStencilClear" }
