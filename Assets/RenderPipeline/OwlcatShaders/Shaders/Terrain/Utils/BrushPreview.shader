...
Shader "Hidden/Owlcat/Terrain/BrushPreview"
{
    SubShader
    {
        ...
        Pass    // 0
        {
            ...
            {
                float3 normal = tex2Dlod(_Normalmap, float4(i.heightmapUV, 0, 0)).xyz * 2 - 1;
                ...
                float4 color = float4(0.5f, 0.5f, 1.0f, 1.0f) * saturate(brushStripe + 0.5f * brushSample) * (slopeFactor);
